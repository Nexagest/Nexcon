...
clientList.put = function(clientsString){
	...
	var clientSect = '<li data-role="list-divider" data-theme="a">Clientes con formularios pendientes</li>';
	var clientSect2 = '<li data-role="list-divider" data-theme="a">Clientes al día</li>';;
	for(var i = 0; i < clients.length - 1; i++){
		var clientInfo = clients[i].split(':');
		if(clientInfo[0] != '0'){
			clientSect += "" +
				"<li data-theme='c'><a href='notifi.php?c="+clientInfo[1]+"'>" +
	...
	var list = $('#clients_list').html() + clientSect + clientSect2;
