	...
	<body>
		<div data-role='page' id='documents' data-theme='b'>
			...
			<div data-role='content'>
				<ul data-role='listview' id='clients_list' data-filter="true" data-filter-theme="a" data-filter-placeholder="Cliente...">
					<li data-role="list-divider" data-theme="a">Clientes</li>
				</ul>
			</div>
